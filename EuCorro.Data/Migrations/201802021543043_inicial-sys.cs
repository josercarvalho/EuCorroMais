namespace EuCorro.Data.Migrations
{
    ...
    public partial class inicialsys : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        TipoDesconto = c.Int(nullable: false),
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Modalidade", "Categoria_CategoriaId", "dbo.Categoria");
            ...
            DropForeignKey("dbo.ModalidadeEvento", "CategoriaId", "dbo.Categoria");
            ...
            DropIndex("dbo.ModalidadeEvento", new[] { "CategoriaId" });
