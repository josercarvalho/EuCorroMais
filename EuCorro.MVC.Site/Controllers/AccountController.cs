...
namespace EuCorro.MVC.Site.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public AccountController(ApplicationUserManager userManager, ApplicationSignInManager signInManager, IUsuarioApp cadastro)
        {
        ...
        {
            if (_cadastro.IsExistEmail(model.Email))
            ...
            if (ModelState.IsValid)
            {
                ...
                var user = new ApplicationUser
                {
                    ...
                    Idade = DateTime.Now.Year - model.DataNascimento.Year,
                    CPF = model.CPF,
                    Camiseta = model.Camiseta,
                    Brasileiro = model.Brasileiro,
                    Sexo = model.Sexo,
